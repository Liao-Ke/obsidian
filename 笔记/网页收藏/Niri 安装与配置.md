---
来自: "https://www.sakimidare.top/posts/niri-manual/"
收藏时间: 2025年11月06日 四 19:09:18
tags:
  - "网页收藏"
---
> [!note] 摘要
> Niri 是一个水平式排列的窗口管理器，与传统的 Windows 桌面或 KDE Plasma 不同。它将新打开的窗口显示在当前窗口的右侧，并提供了快捷键和触摸板操作以实现流畅的窗口切换和动画效果。本文介绍了 Niri 的安装、配置以及一些常用热键，帮助用户在 Arch Linux 系统上实现个性化的桌面体验。
...
![BTW I use arch!](https://www.sakimidare.top/_astro/screenshot1.jGBtkWYf_Z2aUG1.webp) ![Material Design 风格的控制中心](https://www.sakimidare.top/_astro/screenshot2.CUKsAKsn_hIvaB.webp) ![比 Windows 更炫酷的多桌面](https://www.sakimidare.top/_astro/screenshot3.CjbNSAn2_1L6TJA.webp)
...
编辑 `~/.config/systemd/user/niri.service.wants/swayidle.service` 。 填入以下配置：
...
这个配置是为了无操作 600 秒后用 `hyprlock` 锁屏，601 秒后关闭显示器。 如果有睡眠、休眠等需求，请查阅 Swaylock 官方文档。

## 修改 Niri 配置文件

创建 `~/.config/niri/config.kdl` 文件并写入配置。 除了显示器配置，其他你可以抄我的。显示器配置请根据注释自行修改。
