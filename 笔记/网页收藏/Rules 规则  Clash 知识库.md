---
来自: "https://clash.wiki/configuration/rules.html"
收藏时间: 2025年10月25日 六 09:26:22
tags:
  - "网页收藏"
---
> [!note] 摘要
> Clash 是一款开源的网络代理软件，用于管理网络流量、绕过网络限制、提高网络访问速度等。本页面提供了 Clash 的简介、快速开始、服务运行、常见问题、配置、Premium 版本、运行时、高级用法等内容。


## Rules 规则

在 [快速入手](https://clash.wiki/configuration/getting-started.html) 中, 我们介绍了Clash中基于规则的匹配的基本知识. 在本章中, 我们将介绍最新版本的 Clash 中所有可用的规则类型.

```
txt# 类型,参数,策略(,no-resolve)
